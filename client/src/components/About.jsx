...
const About = () => {
    return (
        <div className="relative min-h-screen  w-full px-4  overflow-hidden">
            ...
            {/* Foreground Content */}
            <div className="relative z-10 container mx-auto translate-y-40 ">
                <h1 className="text-[#F6A634] text-2xl font-medium font-[Gellix] text-center mb-8">
                    About Us
                </h1>

                <div className="flex flex-col items-center justify-center gap-5 lg:px-28 text-center">
                    <h2 className="text-zinc-800 text-5xl font-bold font-['Cambon']">
                        Luxury, Tradition And Innovation - All in One Grand Experience
                    </h2>

                    <p className="text-zinc-800 text-xl font-medium font-['Gellix'] leading-9">
