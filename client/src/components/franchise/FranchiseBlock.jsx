        ...
        <div className='container mx-auto w-full'>
            ...
            <section className={`relative flex flex-col md:flex-row items-center gap-10 ${reverse ? 'md:flex-row-reverse' : ''}`}>
                ...
                <article className="flex flex-col gap-4 flex-1">
                    ...
                    <p className=" font-gellix-content-start">
                        {description}
                    </p>
                    <div>
                        <h3 className="text-zinc-800 text-2xl font-bold font-['Cambon']">{inventoryTitle}</h3>
                        <p className="text-zinc-800 text-xl font-medium leading-9 font-['Gellix']" dangerouslySetInnerHTML={{ __html: inventoryItems }} />
                    </div>
