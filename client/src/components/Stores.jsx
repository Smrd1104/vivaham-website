    ...
    return (
        <div className="bg-black md:py-0 py-10 ">
            <div className="relative  text-center  overflow-hidden container mx-auto z-0 ">
                ...
                {/* Content */}
                <div className="absolute z-20  md:translate-y-66 translate-y-32  ">
                    ...
                    <p data-aos="fade-up" data-aos-duration="1200" className=" md:justify-start font-gellix-content-white  md:mx-68 mx-5">Step into Vivaham’s exclusive stores, where craftsmanship meets imagination. From
