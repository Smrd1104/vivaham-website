        ...
        <div className="bg-black py-10 ">
            <div className="relative  text-center  overflow-hidden container mx-auto z-0 ">
                ...
                <div className="absolute z-20  md:translate-y-66 translate-y-24   ">
                    ...
                    <p data-aos="fade-up" data-aos-duration="1200" className="self-stretch md:text-center text-justify md:justify-start font-gellix-content-white  md:mx-68 mx-10">Step into Vivaham’s exclusive stores, where craftsmanship meets imagination. From
