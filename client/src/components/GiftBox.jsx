...
const GiftBox = () => {
    return (
        <div className=" bg-rose-100 px-4 z-10 relative">
            <section className="w-full container mx-auto py-16  flex flex-col justify-center items-center gap-10">
                {/* Heading */}
                <div className="text-center">
                    <h1 data-aos="fade-up" data-aos-delay="800" className="text-black text-5xl font-bold font-cambon leading-[60px]">
                        Vivaham Gift Box
                    </h1>
                    <p data-aos="fade-up" data-aos-delay="900" className="mt-6  mx-auto  font-gellix-medium leading-9">
