        ...
        <div className="relative w-full min-h-[700px]  ">
            ...
            <div className="container mx-auto py-10">
                <div className=" relative self-stretch md:inline-flex  md:justify-start justify-center items-center md:gap-10  md:px-14 px-5 ">
                    ...
                    <div className="md:w-[840px] inline-flex flex-col justify-center items-center md:items-start gap-8">
                        <div className="self-stretch flex flex-col justify-start items-center md:items-start gap-4 md:mt-0 mt-5">
                            <h1 data-aos="fade-up" data-aos-duration="900" className="md:text-start text-center font-gellix-header">The Franchise</h1>
                            <h2 data-aos="fade-up" data-aos-duration="900" className="self-stretch justify-start font-cambon-header  ">Own a Legacy in Luxury Weddings</h2>
                            <h3 data-aos="fade-up" data-aos-duration="900" className="self-stretch justify-start md:text-start text-center text-black md:text-sm text-sm font-bold font-['Gellix'] uppercase md:tracking-[3.20px] tracking-[2.2px]">Your Opportunity to Lead Luxury</h3>
                        </div>
                        ...
                        <Link to="/franchise">
                            <button data-aos="fade-up" data-aos-duration="900" className="px-6 py-3 bg-zinc-800 inline-flex justify-center items-center gap-2.5">
